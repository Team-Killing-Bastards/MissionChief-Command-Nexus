...
DATA="$BASE/osm/data/scotland-latest.osm.pbf"
...
echo "=== Nexus Realism: Scotland import starting ==="
...
echo "=== Nexus Realism: Scotland import complete ==="
