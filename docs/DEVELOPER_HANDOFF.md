...
| Command Nexus version | `3.0.42` |
| Mission Finder baseline | `V10.6.179` |
...
2. Live-validate the 3.0.42 role-aware wake-recovery and managed Worker A admission contract.
