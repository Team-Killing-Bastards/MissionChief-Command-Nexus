...
This document describes the architecture in the current MissionChief Command Nexus v3.0.13 production source and the direction for future consolidation.
