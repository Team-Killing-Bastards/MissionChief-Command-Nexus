...
This document describes the architecture in the current MissionChief Command Nexus v3.0.20 production source and the direction for future consolidation.
