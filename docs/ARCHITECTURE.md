...
This document describes the architecture in the current MissionChief Command Nexus v2.0.0 production source and the direction for future consolidation.
