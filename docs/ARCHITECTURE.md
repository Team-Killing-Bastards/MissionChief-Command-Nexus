...
This document describes the architecture in the current MissionChief Command Nexus v1.1.2 production source and the direction for future consolidation.
