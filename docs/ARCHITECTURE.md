...
This document describes the architecture in the current MissionChief Command Nexus v3.0.22 candidate source and the direction for future consolidation.
