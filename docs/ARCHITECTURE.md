...
This document describes the architecture in the current MissionChief Command Nexus v3.0.21 production source and the direction for future consolidation.
