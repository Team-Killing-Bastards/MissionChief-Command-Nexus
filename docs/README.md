...
This directory separates current operating guidance from versioned historical records. The current candidate baseline is Command Nexus `3.0.22` with Mission Finder `V10.6.177`.
