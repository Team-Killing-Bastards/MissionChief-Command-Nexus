...
This directory separates current operating guidance from versioned historical records. The current candidate baseline is Command Nexus `3.0.30` with Mission Finder `V10.6.177`.
