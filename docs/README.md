...
This directory separates current operating guidance from versioned historical records. The current production baseline is Command Nexus `3.0.12` with Mission Finder `V10.6.177`.
