...
- [x] Publish Command Nexus `3.0.42` with Mission Finder `V10.6.179`, mission-only Worker A, exact personal transport-only Worker B, prisoner-release terminal handling and role-aware wake recovery.
