...
The scenes are conceptual product artwork created for this repository. They are not screenshots of MissionChief, an official MissionChief product, or representations of a real emergency-service control system. No third-party stock imagery, emergency-service crest or MissionChief logo is included.
...
4. Render the SVG locally and inspect it at full width and a narrow README width.
5. Run `python3 scripts/check_repository.py` before publication.
