...
test('all executable code outside reviewed UI and skip-record changes matches the .55 baseline',()=>{
  const baseline=JSON.parse(fs.readFileSync('reference/auto-focus-protected-55.json'));
