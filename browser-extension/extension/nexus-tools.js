...
(() => {
  ...
  *{box-sizing:border-box}[hidden]{display:none!important}button,input,select,textarea{font:inherit}
  ...
  <section id="panel" hidden role="dialog" aria-label="Nexus Tools">
    <header><img class="logo" alt=""><div class="brand"><h1>Nexus Tools</h1><small>MissionChief Command Nexus · 3.0.43.59</small></div><small id="clock"></small><button id="close" aria-label="Close Nexus Tools">×</button></header>
