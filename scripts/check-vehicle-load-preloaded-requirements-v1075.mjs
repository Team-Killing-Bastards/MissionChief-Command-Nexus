...
expect(source.includes('// @version      1.0.119'), 'Expected Command Nexus 1.0.101');
expect(source.includes('MISSION FINDER V10.6.159'), 'Expected Mission Finder V10.6.150');
