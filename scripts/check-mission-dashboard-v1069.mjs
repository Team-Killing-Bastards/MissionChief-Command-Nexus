...
expect(source.includes('// @version      1.0.115'), 'Command Nexus 1.0.69 metadata missing');
expect(source.includes('MISSION FINDER V10.6.156'), 'Mission Finder V10.6.139 header missing');
