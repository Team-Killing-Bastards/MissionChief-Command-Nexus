...
expect(source.includes('// @version      1.0.113'), 'Command Nexus 1.0.69 metadata missing');
expect(source.includes('MISSION FINDER V10.6.154'), 'Mission Finder V10.6.139 header missing');
