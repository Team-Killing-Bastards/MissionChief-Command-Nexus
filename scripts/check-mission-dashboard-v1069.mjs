...
expect(source.includes('// @version      1.0.70'), 'Command Nexus 1.0.69 metadata missing');
expect(source.includes('MISSION FINDER V10.6.133'), 'Mission Finder V10.6.133 header missing');
