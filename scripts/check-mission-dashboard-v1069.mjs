...
expect(source.includes('// @version      1.0.75'), 'Command Nexus 1.0.69 metadata missing');
expect(source.includes('MISSION FINDER V10.6.138'), 'Mission Finder V10.6.138 header missing');
