...
expect(source.includes('// @version      1.0.106'), 'Expected current Command Nexus 1.0.94');
expect(source.includes("const UNIT_VERSION = '3.3.22';"), 'Expected current Unit Naming 3.3.19');
