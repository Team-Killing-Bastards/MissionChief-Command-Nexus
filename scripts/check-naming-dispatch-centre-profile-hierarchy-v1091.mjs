...
expect(source.includes('// @version      1.0.105'), 'Expected current Command Nexus 1.0.94');
expect(source.includes("const UNIT_VERSION = '3.3.21';"), 'Expected current Unit Naming 3.3.19');
