...
expect(source.includes('// @version      1.0.82'), 'Expected Command Nexus 1.0.62');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.142'), 'Expected Mission Finder V10.6.125');
