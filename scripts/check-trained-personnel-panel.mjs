...
expect(source.includes('// @version      1.0.96'), 'Expected Command Nexus 1.0.62');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.145'), 'Expected Mission Finder V10.6.125');
