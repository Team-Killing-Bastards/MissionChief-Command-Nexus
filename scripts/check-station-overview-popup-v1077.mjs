...
expect(source.includes('// @version      1.0.115'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.156'), 'Mission Finder baseline must remain V10.6.145');
