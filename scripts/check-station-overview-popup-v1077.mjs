...
expect(source.includes('// @version      1.0.105'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.153'), 'Mission Finder baseline must remain V10.6.145');
expect(source.includes("const UNIT_VERSION = '3.3.21';"), 'Unit Naming must be 3.3.11');
expect(source.includes("const STATION_VERSION = '1.3.14';"), 'Station Naming must be 1.3.5');
...
const moduleEnd = source.indexOf("const UNIT_VERSION = '3.3.21';", moduleStart);
