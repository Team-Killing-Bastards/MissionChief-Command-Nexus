...
expect(source.includes("const UNIT_VERSION = '3.3.17';"), 'Unit Naming must be 3.3.11');
expect(source.includes("const STATION_VERSION = '1.3.11';"), 'Station Naming must be 1.3.5');
...
const moduleEnd = source.indexOf("const UNIT_VERSION = '3.3.17';", moduleStart);
