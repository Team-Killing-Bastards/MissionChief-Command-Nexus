...
expect(source.includes('// @version      1.0.88'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.144'), 'Mission Finder baseline must remain V10.6.144');
expect(source.includes("const UNIT_VERSION = '3.3.13';"), 'Unit Naming must be 3.3.11');
expect(source.includes("const STATION_VERSION = '1.3.7';"), 'Station Naming must be 1.3.5');
...
const moduleEnd = source.indexOf("const UNIT_VERSION = '3.3.13';", moduleStart);
