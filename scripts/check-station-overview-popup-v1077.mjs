...
expect(source.includes('// @version      1.0.116'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.157'), 'Mission Finder baseline must remain V10.6.145');
