...
expect(source.includes('// @version      1.0.109'), 'Expected current Command Nexus version');
...
expect(source.includes("const STATION_VERSION = '1.3.16';"), 'Station Naming must be 1.3.5');
