...
expect(source.includes('// @version      1.0.81'), 'Expected Command Nexus 1.0.79');
expect(source.includes('MISSION FINDER V10.6.141'), 'Mission Finder baseline must remain V10.6.139');
...
expect(source.includes("const PERSONNEL_VERSION = '1.3.8';"), 'Personnel Assignment must remain 1.3.8');
