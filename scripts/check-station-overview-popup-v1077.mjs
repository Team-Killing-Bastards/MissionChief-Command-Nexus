...
expect(source.includes('// @version      1.0.114'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.155'), 'Mission Finder baseline must remain V10.6.145');
