...
for (const token of ['// @version      1.0.116', 'MISSION FINDER V10.6.157', 'function mfIsExactPatientTransportAnchor(', 'function mfFindExactPatientTransportAnchor(', 'function mfFindExactPatientTransportAnchorDeep(', 'a.btn-success[href*="/patient/"]', '/^\\/vehicles\\/\\d+\\/patient\\/\\d+\\/?(?:[?#].*)?$/']) if (!source.includes(token)) fail(`missing ${token}`);
