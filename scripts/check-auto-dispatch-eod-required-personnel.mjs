...
expect(source.includes('// @version      1.0.68'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.131'), 'Expected current Mission Finder version');
