...
expect(source.includes('// @version      1.0.83'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.143'), 'Expected current Mission Finder version');
