...
expect(source.includes('// @version      1.0.70'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.133'), 'Expected current Mission Finder version');
