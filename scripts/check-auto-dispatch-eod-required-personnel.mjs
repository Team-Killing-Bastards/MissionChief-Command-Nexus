...
expect(source.includes('// @version      1.0.60'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.123'), 'Expected current Mission Finder version');
