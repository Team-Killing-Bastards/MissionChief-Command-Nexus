...
expect(source.includes('// @version      1.0.62'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.125'), 'Expected current Mission Finder version');
