...
expect(source.includes('// @version      1.0.77'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.139'), 'Expected current Mission Finder version');
