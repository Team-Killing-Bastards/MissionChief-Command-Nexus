...
expect(source.includes('// @version      1.0.80'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.140'), 'Expected current Mission Finder version');
