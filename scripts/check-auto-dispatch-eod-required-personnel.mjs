...
expect(source.includes('// @version      1.0.66'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.129'), 'Expected current Mission Finder version');
