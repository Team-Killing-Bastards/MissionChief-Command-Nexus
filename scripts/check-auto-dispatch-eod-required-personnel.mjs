...
expect(source.includes('// @version      1.0.72'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.135'), 'Expected current Mission Finder version');
