...
expect(source.includes('// @version      1.0.75'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.138'), 'Expected current Mission Finder version');
