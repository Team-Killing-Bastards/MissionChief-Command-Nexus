...
expect(source.includes('// @version      1.0.69'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.132'), 'Expected current Mission Finder version');
