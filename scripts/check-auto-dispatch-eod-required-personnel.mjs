...
expect(source.includes('// @version      1.0.73'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.136'), 'Expected current Mission Finder version');
