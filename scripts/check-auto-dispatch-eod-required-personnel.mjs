...
expect(source.includes('// @version      1.0.65'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.128'), 'Expected current Mission Finder version');
