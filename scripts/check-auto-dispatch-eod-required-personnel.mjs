...
expect(source.includes('// @version      1.0.67'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.130'), 'Expected current Mission Finder version');
