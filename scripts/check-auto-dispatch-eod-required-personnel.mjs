...
expect(source.includes('// @version      1.0.71'), 'Expected current Command Nexus version');
expect(source.includes('MISSION FINDER V10.6.134'), 'Expected current Mission Finder version');
