...
expect(source.includes('// @version      1.0.119'), 'Expected Command Nexus 1.0.94');
expect(source.includes("const UNIT_VERSION = '3.3.25';"), 'Expected Unit Naming 3.3.19');
expect(source.includes("const STATION_VERSION = '1.3.20';"), 'Expected Station Naming 1.3.13');
