...
expect(source.includes('// @version      1.0.111'), 'Expected Command Nexus 1.0.94');
expect(source.includes("const UNIT_VERSION = '3.3.23';"), 'Expected Unit Naming 3.3.19');
expect(source.includes("const STATION_VERSION = '1.3.18';"), 'Expected Station Naming 1.3.13');
