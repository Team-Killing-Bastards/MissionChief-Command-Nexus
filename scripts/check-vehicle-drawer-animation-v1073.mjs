...
expect(source.includes('// @version      1.0.75'), 'v1.0.75 metadata missing');
expect(source.includes('MISSION FINDER V10.6.138'), 'V10.6.138 header missing');
expect(
...
console.log(
  'Command Nexus V1.0.75 top-aligned animated Vehicle drawer and action-order checks passed.'
);
