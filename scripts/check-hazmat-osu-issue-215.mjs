...
expect(source.includes('// @version      1.0.70'), 'Expected Command Nexus 1.0.64');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.133'), 'Expected Mission Finder V10.6.127');
