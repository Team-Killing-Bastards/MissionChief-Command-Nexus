...
expect(source.includes('// @version      1.0.111'), 'Expected Command Nexus 1.0.64');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.153'), 'Expected Mission Finder V10.6.127');
