...
expect(source.includes('// @version      1.0.115'), 'Expected Command Nexus 1.0.64');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.156'), 'Expected Mission Finder V10.6.127');
