...
expect(source.includes('// @version      1.0.66'), 'Expected Command Nexus 1.0.64');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.129'), 'Expected Mission Finder V10.6.127');
