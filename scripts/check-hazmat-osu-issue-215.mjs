...
expect(source.includes('// @version      1.0.63'), 'Expected Command Nexus 1.0.63');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.126'), 'Expected Mission Finder V10.6.126');
