...
expect(source.includes('// @version      1.0.67'), 'Expected Command Nexus 1.0.64');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.130'), 'Expected Mission Finder V10.6.127');
