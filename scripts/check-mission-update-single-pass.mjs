...
expect(source.includes('// @version      1.0.71'), 'Expected Command Nexus 1.0.61');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.134'), 'Expected Mission Finder V10.6.124');
