...
expect(source.includes('// @version      1.0.84'), 'Expected Command Nexus 1.0.84');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.144'), 'Expected Mission Finder V10.6.144');
