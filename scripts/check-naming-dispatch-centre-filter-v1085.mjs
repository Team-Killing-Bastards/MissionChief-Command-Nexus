...
// Legacy v1.0.85 safety coverage retained and revalidated for v1.0.87.
...
for (const [text, label] of [
  ['// @version      1.0.87', 'Command Nexus 1.0.87 metadata'],
  ["const UNIT_VERSION = '3.3.12';", 'Unit Naming 3.3.12'],
  ["const STATION_VERSION = '1.3.6';", 'Station Naming 1.3.6'],
...
console.log('Legacy Unit/Station Naming Dispatch Centre safety contracts passed under v1.0.87.');
