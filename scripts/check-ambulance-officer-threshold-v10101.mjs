...
expect(source.includes('// @version      1.0.121'), 'Expected Command Nexus 1.0.104');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.159'), 'Expected Mission Finder V10.6.153');
