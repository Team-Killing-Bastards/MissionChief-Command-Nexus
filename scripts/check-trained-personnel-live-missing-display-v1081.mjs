...
expect(source.includes('// @version      1.0.83'), 'Expected Command Nexus 1.0.81');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.143'), 'Expected Mission Finder V10.6.141');
