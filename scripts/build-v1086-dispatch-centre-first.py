...
t = readme.read_text(encoding='utf-8').replace('**Current version:** `1.0.85`', '**Current version:** `1.0.86`', 1)
readme.write_text(t, encoding='utf-8')
sr = root / 'src/README.md'
t = sr.read_text(encoding='utf-8').replace('1.0.85', '1.0.86')
