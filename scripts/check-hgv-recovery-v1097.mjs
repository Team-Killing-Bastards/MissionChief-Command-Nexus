...
expect(source.includes('// @version      1.0.117'), 'Expected Command Nexus 1.0.101');
expect(source.includes(' * MODULE 2: MISSION FINDER V10.6.158'), 'Expected Mission Finder V10.6.150');
