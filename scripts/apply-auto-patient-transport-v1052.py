...
for path in [Path('.diagnostics/auto-patient-transport-v1052.md'), Path('.github/workflows/inspect-auto-patient-transport-once.yml'), Path('.github/workflows/build-auto-patient-transport-v1052.yml'), Path('scripts/apply-auto-patient-transport-v1052.py')]:
    if path.exists():
        path.unlink()
