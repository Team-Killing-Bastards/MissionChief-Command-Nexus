...
out = ['FIRE ENGINE EXACT MATCH CONTEXT', f'SOURCE LINES: {len(lines)}', '']
...
for name, window in [
    ('getAllMatchingVehicleCheckboxes', 1500),
    ('vehicleValuesMatchCandidates', 500),
    ('getCheckboxVehicleValues', 500),
    ('getVehicleTypeIdentifiers', 500),
    ('findUnitButton', 1600),
]:
...
print('Wrote exact-match context')
