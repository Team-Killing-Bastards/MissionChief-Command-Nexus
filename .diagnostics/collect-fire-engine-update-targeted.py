...
out = ['FIRE ENGINE MATCH/FALLBACK CONTEXT', f'SOURCE LINES: {len(lines)}', '']
...
for name, window in [
    ('getMatchingVehicleCheckboxes', 1000),
    ('countSelectedMatchingVehicles', 900),
    ('findUnitButton', 1000),
    ('isVehicleElementAlreadySelected', 260),
    ('clickVehicleElement', 300),
    ('getVehicleDebugName', 240),
]:
...
for pattern in [
    r'getMatchingVehicleCheckboxes\(',
    r'findUnitButton\(',
...
print('Wrote match/fallback context')
