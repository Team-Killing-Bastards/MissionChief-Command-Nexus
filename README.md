...
**Current version:** `1.0.100` · **Mission Finder engine:** `V10.6.149` · **Platform:** [MissionChief UK](https://www.missionchief.co.uk/) · **Licence:** [MIT](LICENSE)
...
- Dispatch Centre-first scoping for Unit Naming and Station Naming, loaded from MissionChief's native Dispatch Centres view
