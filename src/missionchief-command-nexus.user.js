...
(function () {
    ...
    const PERSONNEL_TARGET_PER_VEHICLE = 2;
    ...
    function addPanel() {
        ...
        document.querySelector('#mc-namer-station-type').onchange = populateStartDropdown;
...
let sessionRuntimeTicker = null;
    ...
    function getTrainingRequirementContribution(
        ...
        if (
            ...
            // Never trust the shared name-derived registry for this sensitive
            // rule. The exact IRV must have been checked live and must contain
            // two Police Inspector-trained personnel.
            if (
            ...
            .map(requirement => {
                ...
                if (
                    ...
                    return (
                        ...
                        `2 Inspector-trained personnel on that exact IRV)`
                    );
                }
            ...
            results.filter(Boolean).forEach(result => {
                ...
                registry.vehicles[vehicleId] = {
                    ...
                    updatedAt:
                        Date.now(),
                    source:
                        `${MF_STRICT_TRAINING_SOURCE_PREFIX}${String(source || 'update').toLowerCase()}-v10669`
                };
    ...
    async function prepareTrainedPersonnelRegistryForRows(
        ...
        (
            ...
            if (!row?.isTrainedPersonnelRequirement) {
                return;
            }
        ...
        return refreshPoliceInspectorRegistryFromLiveVehicles(
            requirements,
            source
        );
    }
