...
5. An off-by-default Mission Analytics Logger with a private URL plus selected-user setup, a bounded local outbox, true own-player generated-mission capture and per-unit dispatch distance/ETA evidence and a separately deployed Google Apps Script backend.
