...
| Item | Value |
|---|---|
| Command Nexus version | `1.1.3` |
| Mission Finder baseline | `V10.7.1` |
...
5. An off-by-default Mission Analytics Logger with per-browser pairing, a bounded local outbox, true own-player generated-mission capture and per-unit dispatch distance/ETA evidence and a separately deployed Google Apps Script backend.
