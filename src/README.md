...
5. An off-by-default Mission Analytics Logger with per-browser pairing, a bounded local outbox, per-unit dispatch distance/ETA evidence and a separately deployed Google Apps Script backend.
