...
- Confirm no unapproved account data, credentials, webhook URLs or private configuration was introduced.
- Do not run Command Nexus alongside either legacy standalone script.

## High-risk source areas

Changes involving dispatch, patient demand, trained-personnel matching, personnel assignment, bulk naming, storage migration, queue continuation, activity capture or lifecycle cleanup require explicit evidence and rollback notes.
